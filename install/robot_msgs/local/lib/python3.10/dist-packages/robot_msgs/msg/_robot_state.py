...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __init__(self, **kwargs):
        ...
        self.current_load = kwargs.get('current_load', int())
        self.max_load = kwargs.get('max_load', int())
    ...
    def __eq__(self, other):
        ...
        if self.angular_velocity != other.angular_velocity:
            return False
        if self.current_load != other.current_load:
            return False
        if self.max_load != other.max_load:
            return False
        return True
    ...
    def current_load(self, value):
        if __debug__:
            assert \
                ...
                "The 'current_load' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'current_load' field must be an integer in [-128, 127]"
        self._current_load = value

    @builtins.property
    def max_load(self):
        """Message field 'max_load'."""
    ...
    def max_load(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'max_load' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'max_load' field must be an integer in [-128, 127]"
