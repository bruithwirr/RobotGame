...
bool robot_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // current_load
    PyObject * field = PyObject_GetAttrString(_pymsg, "current_load");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->current_load = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // max_load
    PyObject * field = PyObject_GetAttrString(_pymsg, "max_load");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->max_load = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * robot_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // current_load
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->current_load);
    {
      int rc = PyObject_SetAttrString(_pymessage, "current_load", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // max_load
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->max_load);
    {
      int rc = PyObject_SetAttrString(_pymessage, "max_load", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
